 ...
 * Use the [SelectedStudentDetailFragment.newInstance] factory method to
...
class SelectedStudentDetailFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SelectedStudentFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SelectedStudentDetailFragment().apply {
